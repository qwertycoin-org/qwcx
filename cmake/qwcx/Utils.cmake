...
function(install_qt5)
    ...
    if("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Linux")
        ...
        if("${CMAKE_SYSTEM_NAME}" STREQUAL "Android")
            set(QT5_DOWNLOAD_URL_TARGET_OS "android")
            set(QT5_DIR_PREFIX "${QT5_DOWNLOAD_VERSION}/android")
            set(QT5_PACKAGE_NAME "qt.qt5.${QT5_DOWNLOAD_VERSION_DOTLESS}.android")
        elseif("${CMAKE_SYSTEM_NAME}" STREQUAL "Linux")
            set(QT5_DOWNLOAD_URL_TARGET_OS "desktop")
    ...
    elseif("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Windows")
        ...
        if("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows")
            ...
            if(MSVC AND CMAKE_SIZEOF_VOID_P EQUAL 8) # 64-bit
                set(QT5_DIR_PREFIX "${QT5_DOWNLOAD_VERSION}/msvc2019_64")
                set(QT5_PACKAGE_NAME "qt.qt5.${QT5_DOWNLOAD_VERSION_DOTLESS}.win64_msvc2019_64")
            elseif(MSVC AND CMAKE_SIZEOF_VOID_P EQUAL 4) # 32-bit
                set(QT5_DIR_PREFIX "${QT5_DOWNLOAD_VERSION}/msvc2019")
                set(QT5_PACKAGE_NAME "qt.qt5.${QT5_DOWNLOAD_VERSION_DOTLESS}.win32_msvc2019")
            else()
    ...
    set(QT5_DOWNLOAD_URL "${QT5_BASE_URL}/${QT5_DOWNLOAD_URL_OS}/${QT5_DOWNLOAD_URL_TARGET_OS}/qt5_${QT5_DOWNLOAD_VERSION_DOTLESS}")
